...
* First, from the first plot we could see the log(gestational weeks) and log(birth weights) have positive linear relation. The weights of birth increase significantly as the weeks are larger.
...
Answer: The mean results I acquired is beta[1] 1.1697017, beta[2] 0.1021125, beta[3] 0.5627788, beta[4] 0.1980668, sigma 0.1612023. They are quite clost to the real results.
```{r}
...
yrep2 <- rstan::extract(mod2)[["log_weight_rep"]] # will need mod2 for later
